...
public abstract class LibyMultiBlock extends BlockWithEntity implements LibySetBlockListener {
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (!state.get(PARENT)) {
            ...
            return onMultiBlockUse(world, state, world.getBlockState(entity.parentPos), pos, entity.parentPos, player, hand, hit);
        }

        return onMultiBlockUse(world, state, state, pos, pos, player, hand, hit);
    }

    public ActionResult onMultiBlockUse(World world, BlockState clickedState, BlockState parentState, BlockPos clickedPos, BlockPos parentPos, PlayerEntity player, Hand hand, BlockHitResult hit) {
