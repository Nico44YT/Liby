...
public class LibyModelHelper {
    ...
    public static LibyModel createBlock(Block block, Identifier parentModel, Identifier... textures) {
        ...
        return new LibyJsonModel(Identifier.of(id.getNamespace(), "block/" + id.getPath()), model);
    }
    ...
    public static LibyModel createParentModel(Identifier modelId, Identifier parentId) {
        JsonObject model = new JsonObject();

        model.addProperty("parent", parentId.toString());

        return new LibyJsonModel(modelId, model);
    }

    public static LibyModel createItemCustom(ItemConvertible convertible, Identifier[] spriteIdentifier, String parentModel) {
        return createItemCustom(convertible.asItem().liby$getId(), spriteIdentifier, parentModel);
    }

    public static LibyModel createItemCustom(Identifier id, Identifier[] spriteIdentifier, String parentModel) {
    ...
    public static LibyModel createCustom(Identifier id, Pair<String, Identifier>[] spriteKeyPair, String parentModel) {
        ...
        return new LibyJsonModel(id, model);
    }

    public static LibyModel createFromJson(Identifier id, String json) {
        return new LibyJsonModel(id, JsonParser.parseString(json).getAsJsonObject());
    }

    public static LibyModel createFromJson(Identifier id, JsonObject object) {
        return new LibyJsonModel(id, object);
    }
}
