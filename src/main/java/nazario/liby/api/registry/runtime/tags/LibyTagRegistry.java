...
public class LibyTagRegistry {
    ...
    @ApiStatus.Internal
    private static final HashMap<String, HashMap<Identifier, List<TagGroupLoader.TrackedEntry>>> MAP = new HashMap<>();
    ...
    public static void addBlocks(Identifier tag, String source, Block @NotNull ... blocks) {
        ...
        for (Block block : blocks) {
            tagEntries.add(TagEntry.create(block.liby$getId()));
        }
