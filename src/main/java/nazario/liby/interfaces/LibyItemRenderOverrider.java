...
public interface LibyItemRenderOverrider {
    default void renderItemInHand(float tickDelta, MatrixStack matrices, VertexConsumerProvider.Immediate vertexConsumers, ClientPlayerEntity player, int light, CallbackInfo ci) {}
    default void renderPlayer(PlayerEntityRenderer playerEntityRenderer, AbstractClientPlayerEntity player, float tickDelta, float g, MatrixStack matrixStack, VertexConsumerProvider vertexConsumerProvider, int light, CallbackInfo ci) {}
    default void shouldRenderPlayer(EntityRenderer<PlayerEntity> playerEntityRenderer, PlayerEntity player, Frustum frustum, double x, double y, double z, CallbackInfoReturnable<Boolean> cir) {}
